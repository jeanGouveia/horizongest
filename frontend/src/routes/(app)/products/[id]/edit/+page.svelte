<script lang="ts">
  ...
  import { Button, Input, Textarea, Select, Checkbox, Card, Alert, TabNavigation, PhotoUpload, Loading, PageContainer } from '$lib/components/ui';
  ...
  <div class="page-header">
    <div class="header-left">
      ...
      <div class="header-title">
        ...
        <p class="header-subtitle">Atualize as informações do produto para refletir no sistema, cardápio digital e marketplaces.</p>
      </div>
    </div>
        ...
        <Card class="section-card">
          ...
          {#if form.is_composto}
            <div class="production-note">
              <p>⚠️ Este produto é composto. Configure a ficha técnica após salvar.</p>
              <Button variant="secondary" size="sm" href="/products/{productId}" style="margin-top: 1rem;">
